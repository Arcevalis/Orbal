...
fun AboutScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Private AI for Android, on device or your own server. Run any GGUF locally with llama.cpp, or connect to LM Studio, Ollama or vLLM. No tracking, no cloud.",
            ...
            InfoCard("License", "MIT License")
            InfoCard("GitHub", "github.com/Arcevalis/Orbal")
