    ...
    Scaffold(
        ...
        Column(
            ...
            HelpSection(
                ...
                content = "Orbal needs a GGUF model file to work. Here\u2019s how to get one:\n\n" +
                    ...
                    "5. In Orbal, go to Settings \u2192 Import GGUF Model\n" +
            ...
            HelpSection(
                title = "Privacy",
                content = "Orbal can run fully offline — inference happens on-device. When you enable Remote Model in Settings, Orbal connects to your own server (LM Studio / Ollama / vLLM) on your local network. No analytics, no tracking — you control where your data goes."
            )
